...
2026-09-14：[新規軌跡・6/18 epochsの追加比較](docs/FRESH_TRAJECTORY_RESULTS.md)を完了しました。
18 epochsではP1がB3より平均Recall/F1を高めFPRを下げましたが、全方式への優越は確認していません。
...
元の6 epochs主解析ではP1はB3よりFPRを下げましたが、平均Recall/F1の改善は確認できていません。
